...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 26 73 10 80 	movl   $0x80107326,(%esp)
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 26 73 10 80 	movl   $0x80107326,(%esp)
...
80103f65:	eb 16                	jmp    80103f7d <kc+0x3d>
80103f67:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      if(p->state == SLEEPING)
...
80103f6b:	74 53                	je     80103fc0 <kc+0x80>
        cprintf("%s \t %d \t RUNNING \t \n", p->name, p->pid);
      else if(p->state == RUNNABLE)
80103f6d:	83 f8 03             	cmp    $0x3,%eax
80103f70:	74 6e                	je     80103fe0 <kc+0xa0>
...
80103f7b:	74 2b                	je     80103fa8 <kc+0x68>
      if(p->state == SLEEPING)
80103f7d:	8b 43 a0             	mov    -0x60(%ebx),%eax
80103f80:	83 f8 02             	cmp    $0x2,%eax
80103f83:	75 e3                	jne    80103f68 <kc+0x28>
        cprintf("%s \t %d \t SLEEPING \t \n", p->name, p->pid);
...
80103fa5:	75 d6                	jne    80103f7d <kc+0x3d>
80103fa7:	90                   	nop
      else if(p->state == RUNNING)
        cprintf("%s \t %d \t RUNNING \t \n", p->name, p->pid);
      else if(p->state == RUNNABLE)
...
80103fd7:	eb 99                	jmp    80103f72 <kc+0x32>
...
80103fe7:	c7 04 24 11 73 10 80 	movl   $0x80107311,(%esp)
80103fee:	89 44 24 08          	mov    %eax,0x8(%esp)
80103ff2:	e8 59 c6 ff ff       	call   80100650 <cprintf>
80103ff7:	e9 76 ff ff ff       	jmp    80103f72 <kc+0x32>
...
{
  return kc();
80105484:	e9 b7 ea ff ff       	jmp    80103f40 <kc>

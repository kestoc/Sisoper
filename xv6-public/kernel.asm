...
801041f9:	75 3c                	jne    80104237 <acquire+0x57>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
8010420a:	75 f4                	jne    80104200 <acquire+0x20>
  ...
  __sync_synchronize();
8010420c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
80104211:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104214:	e8 e7 f3 ff ff       	call   80103600 <mycpu>
80104219:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010421c:	8b 45 08             	mov    0x8(%ebp),%eax
8010421f:	83 c0 0c             	add    $0xc,%eax
80104222:	89 44 24 04          	mov    %eax,0x4(%esp)
80104226:	8d 45 08             	lea    0x8(%ebp),%eax
80104229:	89 04 24             	mov    %eax,(%esp)
8010422c:	e8 5f fe ff ff       	call   80104090 <getcallerpcs>
}
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
80104237:	c7 04 24 81 72 10 80 	movl   $0x80107281,(%esp)
8010423e:	e8 1d c1 ff ff       	call   80100360 <panic>
...
80104264:	74 23                	je     80104289 <release+0x39>
    panic("release");
...
80104279:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
...
80104283:	5d                   	pop    %ebp
  ...
  popcli();
80104284:	e9 a7 fe ff ff       	jmp    80104130 <popcli>
// Release the lock.
void
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104289:	c7 04 24 89 72 10 80 	movl   $0x80107289,(%esp)
